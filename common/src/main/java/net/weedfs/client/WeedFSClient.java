...
public class WeedFSClient {
    ...
    public RequestResult write(String path) {
        ...
        assignedInfo.setPublicUrl(assignedInfo.getPublicUrl().replace("localhost",this.masterAddress).replace("127.0.0.1",this.masterAddress));
        HttpPost post = new HttpPost("http://" + assignedInfo.getPublicUrl() + "/"
                + assignedInfo.getFid());
//        HttpPost post = new HttpPost("http://" + this.vAddress+":"+this.vPort + "/"
//                + assignedInfo.getFid());
